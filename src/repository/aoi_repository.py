...
- FechaInicioCobertura://CAMPO GLOBAL PARA TODAS LAS COBERTURAS VIENE DEL CONTRATO Formato dd/MM/yyyy SIEMPRE esta como la marca de tiempo (fecha) de completado (del documento), trae la fecha más reciente en esa sección de Resumen de eventos del sobre  NUNCA LO DEJES VACIO
