...
- TextoTiempoAdicionalCobertura://CAMPO INDEPENDIENTE DE CADA COBERTURA, Puede estar redactado como “estar vigente por...”, “deberá tener vigencia de...”, “la garantía deberá estar vigente hasta...”, “estará vigente desde... hasta...” o alguna variante. Detecta también expresiones como “por tres (3) años, contados desde la fecha de aceptación” o "Su vigencia será de cinco (5) años, contados a partir de la fecha de puesta en servicio del proyecto". No es necesario que se diga explícitamente “tiempo adicional”; si hay una duración clara aplicable a la cobertura, debes extraerla como texto y además extraerla como unidad (ejemplo: “3 años”) en el campo TiempoAdicionalCobertura.
- TiempoAdicionalCobertura://CAMPO INDEPENDIENTE DE CADA COBERTURA, valor con unidades si hay un plazo adicional, ejemplo del valor: 2 años, 10 meses, 1 día, etc... Si no existe un valor traducible a un valor de tiempo (dígito unidad de tiempo) dejas este campo vacío. Adicional, SIEMPRE TRAE este valor en español (dias, años, meses, etc..).
